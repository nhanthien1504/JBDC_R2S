...
UPDATE chuyenbay SET GaDen = 'SGN' where MaCB = 'VN338';
UPDATE chuyenbay set GaDen = 'SGN', GaDi = 'TMD'  where MaCB = 'VN338';
select * from nhanvien;
select * from maybay;
delete from maybay where MaMB = 999;
...
-- ----------------------------
INSERT INTO `chungnhan` VALUES ('100000000', '154');
